@extends('layouts.vertical', ["page_title"=> "安葬服務報表"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">安葬服務報表</li>
                    </ol>
                </div>
                <h4 class="page-title">安葬服務報表</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('rpg17') }}" method="GET">
                                ...
                                <tbody align="center">
                                    @foreach($proms as $prom)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('rpg17.detail',['year'=>$request->year,'month'=>$key,'prom_id'=>$prom->id]) }}">{{ $data['proms'][$prom->id]['count'] }} </a></td>
                                            @endforeach
                                            <td>{{ $sums[$prom->id] }}</td>
                                        </tr>
                                    @endforeach
