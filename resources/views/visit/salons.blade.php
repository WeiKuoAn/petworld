            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('salons') }}" method="GET">
                                <div class="me-3">
                        ...
                        <div class="col-auto">
                            <div class="text-lg-end my-1 my-lg-0">
                                ...
                                <a href="{{ route('visit.company.create') }}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i>新增美容院</a>
                            </div>
                        </div><!-- end col-->
                    </div> <!-- end row -->
                </div>
