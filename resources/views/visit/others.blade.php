@extends('layouts.vertical', ["page_title"=> "其他業者列表"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">其他業者列表</li>
                    </ol>
                </div>
                <h4 class="page-title">其他業者列表</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('others') }}" method="GET">
                                <div class="me-3">
                        ...
                        <div class="col-auto">
                            <div class="text-lg-end my-1 my-lg-0">
                                ...
                                <a href="{{ route('visit.company.create') }}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i>新增其他業者</a>
                            </div>
                        </div><!-- end col-->
                    </div> <!-- end row -->
                </div>
