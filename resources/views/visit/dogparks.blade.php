            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">狗園列表</li>
                    </ol>
                </div>
                <h4 class="page-title">狗園列表</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-auto">
                            <div class="text-lg-end my-1 my-lg-0">
                                ...
                                <a href="{{ route('visit.company.create') }}" class="btn btn-danger waves-effect waves-light"><i class="mdi mdi-plus-circle me-1"></i>新增狗園</a>
                            </div>
                        </div><!-- end col-->
                    </div> <!-- end row -->
                </div>
