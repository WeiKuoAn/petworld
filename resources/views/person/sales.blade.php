@extends('layouts.vertical', ['page_title' => '個人業務列表'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">個人業務列表</li>
                        </ol>
                    </div>
                    <h4 class="page-title">個人業務列表</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
                            ...
                            <form action="{{ route('person.sales') }}" method="GET">
                                <div class="col-auto d-flex flex-wrap align-items-center">
                                    ...
                                    <div class="me-2">
                                        ...
                                        <input type="text" class="form-control" id="cust_mobile" name="cust_mobile"
                                    ...
                                    <div class="me-2">
                                        ...
                                        <select id="inputState" class="form-select" name="status"
                                            onchange="this.form.submit()">
                                            <option value="not_check" @if (isset($request->status) || $request->status == 'not_check') selected @endif>未對帳
                                            </option>
                                    ...
                                    @foreach ($sales as $sale)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a href="{{ route('sale.check', $sale->id) }}"><button type="button"
