                            ...
                            <div class="col-auto">
                                <form class="d-flex flex-wrap align-items-center" action="{{ route('incomes') }}"
                                    ...
                                    <div class="me-sm-3">
                                        ...
                                        <select id="inputState" class="form-select" name="income"
                                            onchange="this.form.submit()">
                                            <option value="null" @if (isset($request->income) || $request->income == '') selected @endif>請選擇
                                            </option>
                                            @foreach ($incomes as $income)
                                                <option value="{{ $income->id }}"
                                                    @if ($request->income == $income->id) selected @endif>
                                                    {{ $income->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="text-lg-end my-1 my-lg-0 mt-5">
                                    ...
                                    <a href="{{ route('income.create') }}"
                                        class="btn btn-danger waves-effect waves-light"><i
                                            class="mdi mdi-plus-circle me-1"></i>新增收入</a>
                                </div>
                            </div><!-- end col-->
                        </div> <!-- end row -->
                    </div>
