        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route('product.del.data',$data->id) }}" method="POST" id="product-form"  enctype="multipart/form-data" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                    @csrf
                    <div class="row">
    ...
    <div class="row">
        <div class="col-12">
            <div class="text-center mb-3">
                ...
                <button type="submit" class="btn w-sm btn-danger waves-effect waves-light">刪除</button>
            </div>
        </div> <!-- end col -->
    </div>
</form>
