    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-custom sticky sticky-dark">
        <div class="container-fluid">
            ...
            <a class="logo text-uppercase" href="index.html">
                <img src="{{asset('assets/images/logo-light.png')}}" alt="" class="logo-light" height="21">
                <img src="{{asset('assets/images/logo-dark.png')}}" alt="" class="logo-dark" height="21">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a class="btn btn-danger navbar-btn ms-2" href="https://1.envato.market/uboldlaravel" target="_blank">
