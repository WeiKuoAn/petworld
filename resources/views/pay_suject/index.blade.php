                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-4 text-sm-end">
                            <a href="{{ route('pay.suject.create') }}">
                                <button type="button" class="btn btn-danger waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#custom-modal"><i class="mdi mdi-plus-circle me-1"></i>新增支出科目</button>
                            </a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach ($datas as $key=>$data)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('pay.suject.edit',$data->id) }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
