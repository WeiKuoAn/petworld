                            ...
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('pays') }}" method="GET">
                                ...
                                <div class="me-sm-3">
                                    ...
                                    <select id="inputState" class="form-select" name="status" onchange="this.form.submit()">
                                        <option value="null" @if (!isset($request->status) || $request->status == '') selected @endif>請選擇</option>
                                        <option value="0" @if ($request->status == '0') selected @endif>未審核</option>
                                        ...
                                        <td>
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('pay.edit',$data->id) }}"><i class="mdi mdi-pencil me-2 text-muted font-18 vertical-middle"></i>還原</a>
