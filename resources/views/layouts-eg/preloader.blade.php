@extends('layouts.preloader', ["page_title" => "Preloader"])
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card" id="tooltips-container">
                <div class="card-body">
                    <i class="fa fa-info-circle text-muted float-end" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info"></i>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card" id="tooltips-container1">
                <div class="card-body">
                    <i class="fa fa-info-circle text-muted float-end" data-bs-container="#tooltips-container1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info"></i>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card" id="tooltips-container2">
                <div class="card-body">
                    <i class="fa fa-info-circle text-muted float-end" data-bs-container="#tooltips-container2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info"></i>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card" id="tooltips-container3">
                <div class="card-body">
                    <i class="fa fa-info-circle text-muted float-end" data-bs-container="#tooltips-container3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="More Info"></i>
                    ...
                    <div class="todoapp">
                        ...
                        <form name="todo-form" id="todo-form" class="needs-validation mt-3" novalidate>
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button class="btn-primary w-100 btn-md btn waves-effect waves-light" type="submit" id="todo-btn-submit">Add</button>
                                </div>
                            </div>
                        </form>
                    </div> <!-- end .todoapp-->
                    ...
                    <div class="chat-conversation">
                        ...
                        <form class="needs-validation" novalidate name="chat-form" id="chat-form">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <button type="submit" class="btn w-100 btn-danger chat-send waves-effect waves-light">Send</button>
                                </div>
                            </div>
                        </form>
