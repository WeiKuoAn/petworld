    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start">
                        <img class="d-flex align-items-start rounded me-2" src="{{asset('assets/images/users/user-1.jpg')}}" alt="Dominic Keller" height="48">
                    ...
                    <div class="list-group list-group-flush mt-2 font-15">
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action text-primary fw-semibold border-0"><i class='mdi mdi-image-filter-black-white font-16 me-1'></i> News Feed</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-forum font-16 me-1'></i> Messages</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-calendar-month-outline font-16 me-1'></i> Events</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-account-multiple-outline font-16 me-1'></i> Friends</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-video font-16 me-1'></i> Watch Videos</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-image-multiple font-16 me-1'></i> Photos</a>
                        <a href="javascript:void(0);" class="list-group-item list-group-item-action border-0"><i class='mdi mdi-storefront font-16 me-1'></i> Marketplaces</a>
                    </div>

                    <h6 class="font-13 text-muted ps-3 my-3 text-uppercase">Pages you Like</h6>

                    <div class="px-2">
                        <div class="d-flex align-items-start mb-2">
                            <div class="avatar-xs bg-success rounded-circle">
                                <span class="avatar-title font-14 fw-bold text-white">F</span>
                            </div>
                            <div class="w-100 ps-2">
                                <span class="badge bg-pink mt-1 float-end">142</span>
                                <h5 class="mt-1 mb-0 font-family-primary fw-semibold"><a href="javascript: void(0);" class="text-reset">Football Team</a></h5>
                            </div>
                        </div>

                        <div class="d-flex align-items-start mb-2">
                            <div class="avatar-xs bg-warning rounded-circle">
                                <span class="avatar-title font-14 fw-bold text-white">U</span>
                            </div>
                            <div class="w-100 ps-2">
                                <h5 class="mt-1 mb-0 font-family-primary fw-semibold"><a href="javascript: void(0);" class="text-reset">UI/UX Community</a></h5>
                            </div>
                        </div>

                        <div class="d-flex align-items-start mb-2">
                            <div class="avatar-xs bg-info rounded-circle">
                                <span class="avatar-title font-14 fw-bold text-white">W</span>
                            </div>
                            <div class="w-100 ps-2">
                                <h5 class="mt-1 mb-0 font-family-primary fw-semibold"><a href="javascript: void(0);" class="text-reset">Web Designer</a></h5>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <img class="me-2 avatar-sm rounded-circle" src="{{asset('assets/images/users/user-3.jpg')}}" alt="Generic placeholder image">
                        <div class="w-100">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            <img src="{{asset('assets/images/small/img-4.jpg')}}" alt="post-img" class="rounded me-1 mb-3 mb-sm-0 img-fluid">
                        </div>
                        <div class="col">
                            <img src="{{asset('assets/images/small/img-1.jpg')}}" alt="post-img" class="rounded me-1 img-fluid mb-3">
                            <img src="{{asset('assets/images/small/img-3.jpg')}}" alt="post-img" class="rounded me-1 img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img src="{{asset('assets/images/users/user-1.jpg')}}" height="32" class="align-self-start rounded me-2" alt="Arya Stark">
                        <div class="w-100">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <img class="me-2 avatar-sm rounded-circle" src="{{asset('assets/images/users/user-4.jpg')}}" alt="Generic placeholder image">
                        <div class="w-100">
                            <div class="dropdown float-end text-muted">
                                <a href="#" class="dropdown-toggle text-muted font-18" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="mdi mdi-dots-horizontal"></i>
                    ...
                    <div class="mt-3">
                        <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted ps-0"><i class="mdi mdi-heart-outline text-danger"></i> 751 Likes</a>
                    ...
                    <div class="post-user-comment-box mt-2">
                        ...
                        <div class="d-flex align-items-start mt-2">
                            <a class="pe-2" href="#">
                                <img src="{{asset('assets/images/users/user-1.jpg')}}" class="rounded-circle" alt="Generic placeholder image" height="31">
                            </a>
                            <div class="w-100">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-start">
                        <img class="me-2 avatar-sm rounded-circle" src="{{asset('assets/images/users/user-6.jpg')}}" alt="Generic placeholder image">
                        <div class="w-100">
                            <div class="dropdown float-end text-muted">
                                <a href="#" class="dropdown-toggle text-muted font-18" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="mdi mdi-dots-horizontal"></i>
                    ...
                    <div class="mt-2">
                        <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted ps-0"><i class="mdi mdi-heart text-danger"></i> 1.5k Likes</a>
