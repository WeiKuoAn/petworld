            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start mb-3">
                        <img src="{{asset('assets/images/users/user-1.jpg')}}" class="me-2 rounded-circle" height="42" alt="Brandon Smith">
                        <div class="w-100">
                            ...
                            <div data-simplebar style="max-height: 375px;">
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-2.jpg')}}" class="me-2 rounded-circle" height="42" alt="Brandon Smith" />
                                        <div class="w-100">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-5.jpg')}}" class="me-2 rounded-circle" height="42" alt="James Z" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-7.jpg')}}" class="me-2 rounded-circle" height="42" alt="Maria C" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start bg-light p-2">
                                        <img src="{{asset('assets/images/users/user-10.jpg')}}" class="me-2 rounded-circle" height="42" alt="Rhonda D" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-3.jpg')}}" class="me-2 rounded-circle" height="42" alt="Michael H" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-6.jpg')}}" class="me-2 rounded-circle" height="42" alt="Thomas R" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                                <span class="float-end text-muted fw-normal font-12">Tue</span>
                                                Thomas R
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-8.jpg')}}" class="me-2 rounded-circle" height="42" alt="Thomas J" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                                                <span class="float-end text-muted fw-normal font-12">Tue</span>
                                                Thomas J
                                ...
                                <a href="javascript:void(0);" class="text-body">
                                    <div class="d-flex align-items-start p-2">
                                        <img src="{{asset('assets/images/users/user-4.jpg')}}" class="me-2 rounded-circle" height="42" alt="Ricky J" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-14">
                    ...
                    <div class="row justify-content-between py-1">
                        <div class="col-sm-7">
                            <div class="d-flex align-items-start">
                                <img src="{{asset('assets/images/users/user-5.jpg')}}" class="me-2 rounded-circle" height="36" alt="Brandon Smith">
                                <div>
                                    <h5 class="mt-0 mb-0 font-15">
