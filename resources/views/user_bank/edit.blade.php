@extends('layouts.vertical', ["page_title"=> "編輯專員戶頭"])
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">編輯專員戶頭</li>
                    </ol>
                </div>
                <h4 class="page-title">編輯專員戶頭</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('user.bank.edit.data',$data->id) }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <div class="mb-3">
                                   ...
                                   <input type="text" class="form-control" name="money" value="{{ $data->money }}" required>
                               </div>
                           </div>
                        </div> <!-- end col-->
                    </div>
