@extends('layouts.vertical', ["page_title"=> "刪除支出key單"])
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">刪除支出Key單</li>
                    </ol>
                </div>
                <h5 class="page-title">刪除支出Key單</h5>
            </div>
        </div>
    </div>
    <!-- end page title -->

    <form action="{{ route('pay.del.data',$data->id) }}" method="POST" id="your-form"  enctype="multipart/form-data" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
        @csrf
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
    ...
    <div class="row">
        <div class="col-12">
            <div class="text-center mb-3">
                ...
                <button type="submit" id="btn_submit" class="btn w-sm btn-success waves-effect waves-light">刪除</button>
