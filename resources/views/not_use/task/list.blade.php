@extends('layouts.vertical', ["page_title"=> "Tasks Listing"])
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-sm-flex justify-content-between">
                                                            <div id="tooltips-container">
                                                                <img src="{{asset('assets/images/users/user-9.jpg')}}" lt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Arya S" />
                                                            </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-sm-flex justify-content-between">
                                                            <div id="tooltips-container1">
                                                                <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container1" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to James B" />
                                                            </div>
                                                            <div class="mt-3 mt-sm-0">
                                                                <ul class="list-inline font-13 text-sm-end">
                                                                    <li class="list-inline-item pe-1">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="d-sm-flex justify-content-between">
                                                            <div id="tooltips-container2">
                                                                <img src="{{asset('assets/images/users/user-4.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Kevin C" />
                                                            </div>
                                                            <div class="mt-3 mt-sm-0">
                                                                <ul class="list-inline font-13 text-sm-end">
                                                                    <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container3">
                                                                    <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to James B" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container4">
                                                                    <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container4" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to James B" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container5">
                                                                    <img src="{{asset('assets/images/users/user-7.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container5" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Edward S" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container6">
                                                                    <img src="{{asset('assets/images/users/user-9.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container6" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Arya S" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container7">
                                                                    <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container7" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to James B" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container8">
                                                                    <img src="{{asset('assets/images/users/user-9.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container8" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Arya S" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container9">
                                                                    <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container9" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to James B" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item pe-1">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="d-sm-flex justify-content-between">
                                                                <div id="tooltips-container10">
                                                                    <img src="{{asset('assets/images/users/user-4.jpg')}}" alt="image" class="avatar-xs rounded-circle" data-bs-container="#tooltips-container10" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Assigned to Kevin C" />
                                                                </div>
                                                                <div class="mt-3 mt-sm-0">
                                                                    <ul class="list-inline font-13 text-sm-end">
                                                                        <li class="list-inline-item">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <div class="d-flex align-items-start mt-3 p-1">
                                        <img src="{{asset('assets/images/users/user-9.jpg')}}" class="me-2 rounded-circle" height="36" alt="Arya Stark" />
                                        <div class="w-100">
                                    ...
                                    <div class="d-flex align-items-start mt-2 p-1">
                                        <img src="{{asset('assets/images/users/user-5.jpg')}}" class="me-2 rounded-circle" height="36" alt="Dominc B" />
                                        <div class="w-100">
                                            <h5 class="mt-0 mb-0 font-size-14">
