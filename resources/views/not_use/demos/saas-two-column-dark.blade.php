@extends('layouts.two-column', ["page_title"=> "Saas (Two Column Layout)", "mode" => $mode ?? "", "demo" => $demo ?? "saas", "theme" => $theme ?? "dark"])
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Two Column</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="49" aria-valuemin="0" aria-valuemax="100" style="width: 49%">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="18" aria-valuemin="0" aria-valuemax="100" style="width: 18%">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="progress progress-sm m-0">
                            <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="74" aria-valuemin="0" aria-valuemax="100" style="width: 74%">
                ...
                <div class="card-body">
                    ...
                    <div id="cardCollpase1" class="collapse pt-3 show">
                        <div class="text-center">
                            <div id="lifetime-sales" data-colors="#00acc1,#6658dd"></div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase2" class="collapse pt-3 show">
                        <div class="text-center">
                            <div id="income-amounts" data-colors="#6658dd"></div>
                            <div class="row mt-3">
                                <div class="col-4">
                                    <p class="text-muted font-15 mb-1 text-truncate">Target</p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div id="cardCollpase3" class="collapse pt-3 show">
                        <div class="text-center">
                            <div id="total-users" data-colors="#00acc1,#6658dd,#e3eaef,#fd7e14"></div>
                            <div class="row mt-3">
                                <div class="col-4">
                                    <p class="text-muted font-15 mb-1 text-truncate">Target</p>
