            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="inbox-leftbar">
                        ...
                        <a href="{{route('second', ['email', 'compose'])}}" class="btn btn-danger w-100 waves-effect waves-light">Compose</a>
                    ...
                    <div class="inbox-rightbar">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex align-items-start mb-3 mt-1">
                                <img class="d-flex me-2 rounded-circle" src="{{asset('assets/images/users/user-2.jpg')}}" alt="placeholder image" height="32">
                                <div class="w-100">
                                    ...
                                    <div class="card mb-1 shadow-none border">
                                        <div class="p-2">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col ps-0">
                                                    <a href="javascript:void(0);" class="text-muted fw-bold">ubold-admin-design.zip</a>
