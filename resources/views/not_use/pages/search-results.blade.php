@extends('layouts.vertical', ["page_title"=> "Search Results"])
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="search-item">
                                        <div class="d-flex align-items-start">
                                            <img class="d-flex me-3 rounded-circle" src="{{asset('assets/images/users/user-1.jpg')}}" alt="Generic placeholder image" height="54">
                                            <div class="w-100">
                                                <h5 class="mt-0">
                        ...
                        <div class="tab-pane" id="users">
                            ...
                            <div class="search-item">
                                <div class="d-flex align-items-start">
                                    <img class="d-flex me-3 rounded-circle" src="{{asset('assets/images/users/user-2.jpg')}}" alt="Generic placeholder image" height="54">
                                    <div class="w-100">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="d-flex align-items-start">
                                    <img class="d-flex me-3 rounded-circle" src="{{asset('assets/images/users/user-3.jpg')}}" alt="Generic placeholder image" height="54">
                                    <div class="w-100">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="d-flex align-items-start">
                                    <img class="d-flex me-3 rounded-circle" src="{{asset('assets/images/users/user-4.jpg')}}" alt="Generic placeholder image" height="54">
                                    <div class="w-100">
                                        <h5 class="mt-0">
                            ...
                            <div class="search-item">
                                <div class="d-flex align-items-start">
                                    <img class="d-flex me-3 rounded-circle" src="{{asset('assets/images/users/user-5.jpg')}}" alt="Generic placeholder image" height="54">
                                    <div class="w-100">
                                        <h5 class="mt-0">
