@extends('layouts.vertical', ["page_title"=> "Error Page | 404 | Page not Found"])
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6 col-xl-4 mb-4">
            ...
            <div class="text-center">
                ...
                <a href="{{route('any', 'index')}}" class="btn btn-success waves-effect waves-light">Back to Dashboard</a>
            </div>
            <!-- end row -->
