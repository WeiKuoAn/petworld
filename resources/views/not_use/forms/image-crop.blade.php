@extends('layouts.vertical', ["page_title"=> "Cropper Image Crop"])
                    ...
                    <div class="row">
                        <div class="col-xl-9 img-crop-preview-btns docs-buttons">
                            <div class="btn-group">
                                <button type="button" class="btn btn-outline-secondary btn-sm" data-method="setDragMode" data-option="move" title="Move">
                                    <span class="docs-tooltip" data-bs-placement="top" data-bs-toggle="tooltip" data-animation="false" title="$().cropper(&quot;setDragMode&quot;, &quot;move&quot;)">
                            ...
                            <div class="btn-group">
                                ...
                                <label class="btn btn-outline-secondary mb-0 btn-upload btn-sm" for="inputImage" title="Upload image file">
                                    <input type="file" class="visually-hidden" id="inputImage" name="file" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff">
                        ...
                        <div class="col-xl-3 docs-toggles">
                            <div class="btn-group btn-group-sm d-flex flex-nowrap" data-toggle="buttons">
                                <label class="btn btn-outline-secondary form-label active">
                            ...
                            <div class="btn-group btn-group-sm d-flex flex-nowrap" data-toggle="buttons">
                                <label class="btn btn-outline-secondary form-label active">
                                    <input type="radio" class="visually-hidden" id="viewMode0" name="viewMode" value="0" checked>
                                    <span class="docs-tooltip" data-toggle="tooltip" data-animation="false" title="View Mode 0">
                                        VM0
                                    </span>
                                </label>
                                <label class="btn btn-outline-secondary form-label">
                                    <input type="radio" class="visually-hidden" id="viewMode1" name="viewMode" value="1">
                                    <span class="docs-tooltip" data-toggle="tooltip" data-animation="false" title="View Mode 1">
                                        VM1
                                    </span>
                                </label>
                                <label class="btn btn-outline-secondary form-label">
                                    <input type="radio" class="visually-hidden" id="viewMode2" name="viewMode" value="2">
                                    <span class="docs-tooltip" data-toggle="tooltip" data-animation="false" title="View Mode 2">
                                        VM2
                                    </span>
                                </label>
                                <label class="btn btn-outline-secondary form-label">
                                    <input type="radio" class="visually-hidden" id="viewMode3" name="viewMode" value="3">
                            ...
                            <div class="dropdown dropup docs-options d-grid">
                                <button type="button" class="btn btn-outline-info dropdown-toggle" id="toggleOptions" data-bs-toggle="dropdown" aria-expanded="true">
