                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check mb-2 form-check-blue">
                                <input class="form-check-input rounded-circle" type="checkbox" value="" id="customckeck15" checked>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check mb-2 form-check-blue">
                                <input class="form-check-input rounded-circle" type="checkbox" value="" id="customckeck23" checked disabled>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="radio" id="customradio1">
                                        <label class="form-check-label" for="customradio1">Default</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-success">
                                        <input class="form-check-input" type="radio" id="customradio2" checked>
                                        <label class="form-check-label" for="customradio2">Success</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-info">
                                        <input class="form-check-input" type="radio" id="customradio3">
                                        <label class="form-check-label" for="customradio3">Info</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-danger">
                                        <input class="form-check-input" type="radio" id="customradio4" checked>
                                        <label class="form-check-label" for="customradio4">Danger</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-info">
                                        <input class="form-check-input" type="radio" id="customradio5">
                                        <label class="form-check-label" for="customradio5">Info</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-primary">
                                        <input class="form-check-input" type="radio" id="customradio6" checked>
                                        <label class="form-check-label" for="customradio6">Primary</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-pink">
                                        <input class="form-check-input" type="radio" id="customradio7">
                                        <label class="form-check-label" for="customradio7">Pink</label>
                                    </div>

                                    <div class="form-check mb-2 form-check-dark">
                                        <input class="form-check-input" type="radio" id="customradio8" checked>
                                        <label class="form-check-label" for="customradio8">Dark</label>
                                    </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-check form-check-danger mb-2">
                                <input class="form-check-input" type="radio" id="customradio1" checked disabled>
                                <label class="form-check-label" for="customradio1">Zero</label>
                            </div>

                            <div class="form-check mb-2 form-check-dark">
                                <input class="form-check-input" type="radio" id="customradio2" checked disabled>
                                <label class="form-check-label" for="customradio2">One</label>
                            </div>

                            <div class="form-check mb-2 form-check-blue">
                                <input class="form-check-input" type="radio" id="customradio3" checked disabled>
                                <label class="form-check-label" for="customradio3">Two</label>
                            </div>

                            <div class="form-check mb-2 form-check-pink">
                                <input class="form-check-input" type="radio" id="customradio4" checked disabled>
                                <label class="form-check-label" for="customradio4">Three</label>
                            </div>
                        </div> <!-- end col -->
