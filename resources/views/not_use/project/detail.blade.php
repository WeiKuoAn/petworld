@extends('layouts.vertical', ["page_title"=> "Project Details"])
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <div id="tooltips-container">
                        ...
                        <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mt-2">
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img class="me-2 avatar-sm rounded-circle" src="{{asset('assets/images/users/user-2.jpg')}}" alt="Generic placeholder image">
                            <div class="w-100">
