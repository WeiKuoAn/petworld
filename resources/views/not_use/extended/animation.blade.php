@extends('layouts.vertical', ["page_title"=> "Animation"])
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <button class="btn input-group-text btn-primary waves-light waves-effect js--triggerAnimation" type="button">Animate Me !</button>
                                </div>
                                <!-- /input-group -->
