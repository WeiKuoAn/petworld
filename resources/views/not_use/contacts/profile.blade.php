                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="timeline">
                            ...
                            <div class="border border-light p-2 mb-3">
                                ...
                                <img src="{{asset('assets/images/small/img-1.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{asset('assets/images/small/img-2.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{asset('assets/images/small/img-3.jpg')}}" alt="post-img" class="rounded" height="60" />
