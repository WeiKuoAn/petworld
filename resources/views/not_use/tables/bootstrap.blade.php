@extends('layouts.vertical', ["page_title"=> "Bootstrap Tables"])
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table data-toggle="table" data-show-columns="false" data-page-list="[5, 10, 20]" data-page-size="5" data-buttons-class="xs btn-light" data-pagination="true" class="table table-bordered table-hover table-borderless">
