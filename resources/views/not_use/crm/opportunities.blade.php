@extends('layouts.vertical', ["page_title"=> "CRM Opportunities"])
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <div class="d-flex align-items-start">
                                <img class="d-flex align-self-center me-3 rounded-circle" src="{{asset('assets/images/companies/amazon.png')}}" alt="Generic placeholder image" height="64">
                                <div class="w-100">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <div class="d-flex align-items-start">
                                <img class="d-flex align-self-center me-3 rounded-circle" src="{{asset('assets/images/companies/apple.png')}}" alt="Generic placeholder image" height="64">
                                <div class="w-100">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <div class="d-flex align-items-start">
                                <img class="d-flex align-self-center me-3 rounded-circle" src="{{asset('assets/images/companies/google.png')}}" alt="Generic placeholder image" height="64">
                                <div class="w-100">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <div class="d-flex align-items-start">
                                <img class="d-flex align-self-center me-3 rounded-circle" src="{{asset('assets/images/companies/airbnb.png')}}" alt="Generic placeholder image" height="64">
                                <div class="w-100">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-sm-4">
                            <div class="d-flex align-items-start">
                                <img class="d-flex align-self-center me-3 rounded-circle" src="{{asset('assets/images/companies/cisco.png')}}" alt="Generic placeholder image" height="64">
                                <div class="w-100">
