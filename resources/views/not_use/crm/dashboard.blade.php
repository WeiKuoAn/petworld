                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-sm table-nowrap table-centered mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <h5 class="font-15 my-1 fw-normal">Jeremy Young</h5>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="font-15 my-1 fw-normal">Thomas Krueger</h5>
                                        <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                    </td>
                                    <td>235</td>
                                    <td>127</td>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="font-15 my-1 fw-normal">Pete Burdine</h5>
                                        <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                    </td>
                                    <td>365</td>
                                    <td>148</td>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="font-15 my-1 fw-normal">Mary Nelson</h5>
                                        <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                    </td>
                                    <td>753</td>
                                    <td>159</td>
                                ...
                                <tr>
                                    <td>
                                        <h5 class="font-15 my-1 fw-normal">Kevin Grove</h5>
                                        <span class="text-muted mb-1 d-block font-13">Senior Sales Executive</span>
                                    </td>
                                    <td>458</td>
                                    <td>126</td>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-2.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-3.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-4.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-5.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                            <span class="badge badge-soft-warning float-end">Cold lead</span>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-1.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                            <span class="badge badge-soft-warning float-end">Cold lead</span>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-3 rounded-circle" src="{{asset('assets/images/users/user-6.jpg')}}" width="40" alt="Generic placeholder image">
                        <div class="w-100">
                            <span class="badge badge-soft-success float-end">Won lead</span>
