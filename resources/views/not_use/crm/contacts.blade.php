@extends('layouts.vertical', ["page_title"=> "CRM Contacts"])
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="table-user">
                                        <img src="{{asset('assets/images/users/user-8.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                ...
                                <tr>
                                    <td class="table-user">
                                        <img src="{{asset('assets/images/users/user-9.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                ...
                                <tr>
                                    <td class="table-user">
                                        <img src="{{asset('assets/images/users/user-10.jpg')}}" alt="table-user" class="me-2 rounded-circle">
