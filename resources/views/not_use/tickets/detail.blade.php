@extends('layouts.vertical', ["page_title"=> "Support Ticket Details"])
        ...
        <div class="col-xl-8 col-lg-7">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p>
                                <i class='mdi mdi-ticket font-18 text-success me-1 align-middle'></i> Payments
                            </p>
                            <!-- end Ticket Type -->
                        </div>
                    </div> <!-- end row -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="{{asset('assets/images/users/user-2.jpg')}}" alt="Arya S" class="rounded-circle me-2" height="24" />
                                <div class="w-100">
                                    <p> Thelma Fridley </p>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start">
                        <img class="me-2 rounded-circle" src="{{asset('assets/images/users/user-9.jpg')}}" alt="Generic placeholder image" height="32">
                        <div class="w-100">
                            <h5 class="mt-0 mb-1">Jonathan Andrews <small class="text-muted float-end">3 hours ago</small></h5>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-2 rounded-circle" src="{{asset('assets/images/users/user-2.jpg')}}" alt="Generic placeholder image" height="32">
                        <div class="w-100">
                            <h5 class="mt-0 mb-1">Thelma Fridley <small class="text-muted float-end">5 hours ago</small></h5>
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <a class="pe-2" href="#">
                            <img src="{{asset('assets/images/users/user-9.jpg')}}" class="rounded-circle" alt="Generic placeholder image" height="32">
                        </a>
                        <div class="w-100">
                            <h5 class="mt-0 mb-1">Jonathan Andrews <small class="text-muted float-end">1 day ago</small></h5>
