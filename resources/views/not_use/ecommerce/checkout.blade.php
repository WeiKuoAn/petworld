                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-nowrap mb-0">
                                        <tbody>
                                            <tr>
                                                <td style="width: 90px;">
                                                    <img src="{{asset('assets/images/products/product-1.png')}}" alt="product-img" title="product-img" class="rounded" height="48" />
                                                </td>
                                                <td>
                                                    <a href="{{route('second', ['ecommerce', 'product-detail'])}}" class="text-body fw-semibold">Polo Navy blue T-shirt</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('assets/images/products/product-2.png')}}" alt="product-img" title="product-img" class="rounded" height="48" />
                                                </td>

                                                <td>
                                                    <a href="{{route('second', ['ecommerce', 'product-detail'])}}" class="text-body fw-semibold">Red Hoodie for men</a>
                                            ...
                                            <tr>
                                                <td>
                                                    <img src="{{asset('assets/images/products/product-3.png')}}" alt="product-img" title="product-img" class="rounded me-2" height="48" />
                                                </td>
                                                <td>
                                                    <a href="{{route('second', ['ecommerce', 'product-detail'])}}" class="text-body fw-semibold">Designer Awesome T-Shirt</a>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <select data-toggle="select2" title="Country" class="form-control" data-width="100%">
