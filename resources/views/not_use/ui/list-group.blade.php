        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item"><i class="mdi mdi-google-drive me-1"></i> Google Drive</li>
                        <li class="list-group-item"><i class="mdi mdi-message-outline me-1"></i> Facebook Messenger</li>
                        <li class="list-group-item"><i class="mdi mdi-apple me-1"></i> Apple Technology Company</li>
                        <li class="list-group-item"><i class="mdi mdi-lifebuoy me-1"></i> Intercom Support System</li>
                        <li class="list-group-item"><i class="mdi mdi-credit-card-outline me-1"></i> Paypal Payment Gateway</li>
                    </ul>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item disabled" aria-disabled="true"><i class="mdi mdi-google-drive me-1"></i> Google Drive</li>
                        <li class="list-group-item"><i class="mdi mdi-message-outline me-1"></i> Facebook Messenger</li>
                        <li class="list-group-item"><i class="mdi mdi-apple me-1"></i> Apple Technology Company</li>
                        <li class="list-group-item"><i class="mdi mdi-lifebuoy me-1"></i> Intercom Support System</li>
                        <li class="list-group-item"><i class="mdi mdi-credit-card-outline me-1"></i> Paypal Payment Gateway</li>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">And if you want <code>&lt;label&gt;</code>s as the <code>.list-group-item</code> for large hit areas, you can do that, too.</p>
        ...
        <div class="col-xl-4">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="sub-header">Numbers are generated by <code>counter-reset</code> on the <code>&lt;ol&gt;</code>, and then styled and placed with a <code>::before</code> psuedo-element on the <code>&lt;li&gt;</code> with <code>counter-increment</code> and <code>content</code>.</p>
