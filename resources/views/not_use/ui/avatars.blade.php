            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <img src="{{asset('assets/images/users/user-4.jpg')}}" alt="image" class="img-fluid avatar-md rounded" />
                            <p>
                                <code>.avatar-md</code>
                            </p>
                        </div>
                        ...
                        <div class="col-md-3">
                            <img src="{{asset('assets/images/users/user-6.jpg')}}" alt="image" class="img-fluid avatar-xl rounded" />
                            <p class="mb-0">
                                <code>.avatar-xl</code>
                            </p>
                        </div>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <img src="{{asset('assets/images/users/user-7.jpg')}}" alt="image" class="img-fluid avatar-md rounded-circle" />
                            <p class="mt-1">
                        ...
                        <div class="col-md-4">
                            <img src="{{asset('assets/images/users/user-8.jpg')}}" alt="image" class="img-fluid avatar-lg rounded-circle" />
                            <p>
                        ...
                        <div class="col-md-4">
                            <img src="{{asset('assets/images/users/user-9.jpg')}}" alt="image" class="img-fluid avatar-xl rounded-circle" />
                            <p class="mb-0">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <img src="{{asset('assets/images/small/img-2.jpg')}}" alt="image" class="img-fluid rounded" width="200" />
                            <p class="mb-0">
                                <code>.rounded</code>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-2 text-center">
                            <img src="{{asset('assets/images/users/user-5.jpg')}}" alt="image" class="img-fluid rounded" width="120" />
                            <p class="mb-0">
                                <code>.rounded</code>
                            </p>
                        </div>
                        ...
                        <div class="col-sm-2 text-center">
                            <img src="{{asset('assets/images/users/user-7.jpg')}}" alt="image" class="img-fluid rounded-circle" width="120" />
                            <p class="mb-0">
                        ...
                        <div class="col-sm-2">
                            <img src="{{asset('assets/images/users/user-8.jpg')}}" alt="image" class="img-fluid rounded-circle img-thumbnail" width="120" />
                            <p class="mb-0">
