...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <div class="card text-light bg-dark text-xs-center">
                <div class="card-body">
                    <blockquote class="card-bodyquote">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere
                            erat a ante.</p>
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="my-4">Horizontal Card</h4>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card mb-3">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="{{asset('assets/images/small/img-5.jpg')}}" alt="..." class="img-fluid">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
                                    <h5 class="card-title">Card title</h5>
                ...
                <div class="col-lg-6">
                    <div class="card mb-3">
                        <div class="row g-0">
                            ...
                            <div class="col-md-4">
                                <img src="{{asset('assets/images/small/img-6.jpg')}}" alt="..." class="img-fluid">
                            </div>
                        </div>
                    </div>
                </div>
