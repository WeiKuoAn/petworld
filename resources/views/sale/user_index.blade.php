                    ...
                    <div class="row justify-content-between">
                        <form action="{{ route('user.sale',$user->id) }}" method="GET">
                                <div class="col-auto d-flex flex-wrap align-items-center">
                                        ...
                                        <div class="me-2">
                                            <label for="after_date" class="form-label">付款方式</label>
                                        ...
                                        <div class="me-2">
                                            <label for="after_date" class="form-label">狀態</label>
                                            ...
                                            @if ($sale->status != '9')
                                                <div class="btn-group dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <a class="dropdown-item" href=""><i class="mdi mdi-send me-2 font-18 text-muted vertical-middle"></i>送出對帳</a> --}}
                                                    </div>
                                                </div>
                                            @else
