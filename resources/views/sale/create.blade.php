                                                    ...
                                                    <tr id="row-{{ $i }}">
                                                        ...
                                                        <td>
                                                            <input type="text" class="mobile form-control"
                                                                id="souvenir_comment_{{ $i }}"
                                                                name="souvenir_comment[]" value="">
                                                        </td>
                                                    </tr>
                                                @endfor
                                            </tbody>
...
<script src="{{asset('assets/libs/bootstrap-maxlength/bootstrap-maxlength.min.js')}}"></script> --}}
    ...
    <script>
        ...
        $("table.product-list tbody").on("click", ".ibtnAdd_product", function() {
            ...
            cols += ' name="souvenir_ids[]" onchange="chgProducts(this)">';
            cols += '<option value="">請選擇....</option>';
            @foreach ($souvenirs as $souvenir)
                cols += '<option value="{{ $souvenir->id }}">';
                cols += ' {{ $souvenir->name }}';
                cols += '</option>';
            @endforeach
            cols += '</td>';
            ...
            cols += '   id="souvenir_num_' + rowCount + '" name="souvenir_num[]"';
            cols += '   onchange="chgNums(this)" onclick="chgNums(this)"';
            cols += '    onkeydown="chgNums(this)">';
            cols += '</td>';
            cols += '<td>';
            cols += '<input type="number" class="mobile form-control total_number"';
            cols += ' id="souvenir_total_' + rowCount + '"';
            cols += ' name="souvenir_total[]" value="">';
            cols += '</td>';
            cols += '<td>';
            cols += '<input type="text" class="mobile form-control"';
            cols += ' id="souvenir_comment_' + rowCount + '"';
            cols += ' name="souvenir_comment[]" value="">';
            cols += '</td>';
            cols += '</tr>';
            newRow.append(cols);
