...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <form action="{{ route('sale.data.check', $data->id) }}" method="POST" id="your-form" enctype="multipart/form-data"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="date" class="form-control" id="sale_date" name="sale_date"
                                        value="{{ $data->sale_date }}" required readonly>
                                </div>
                                    ...
                                    <select id="type" class="form-select" name="customer_id" disabled>
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}"
                                                @if ($data->customer_id == $customer->id) selected @endif readonly>
                                    ...
                                    <select id="type" class="form-select" name="type" disabled>
                                        ...
                                        @foreach ($sources as $source)
                                            <option value="{{ $source->code }}"
                                                @if ($source->code == $data->type) selected @endif readonly>
                                                {{ $source->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="mb-3 col-md-4 not_final_show not_memorial_show">
                                    ...
                                    <input type="text" class="form-control total_number" id="plan_price"
                                        name="plan_price" value="{{ $data->plan_price }}" readonly>
                                </div>
                                <div class="mb-3 col-md-4 not_memorial_show" id="final_price">
                                    <label for="plan_price" class="form-label">尾款價格<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control total_number" name="final_price"
                                        value="{{ $data->pay_price }}" readonly>
                                </div>
                                <div class="mb-3 col-md-4">
                                                    ...
                                                    <tr id="row-{{ $key }}">
                                                        <td>
                                                            <select id="select_prom_{{ $key }}"
                                                                ...
                                                                name="select_proms[]" onchange="chgItems(this)" disabled>
                                                                <option value="" selected>請選擇</option>
                                                                <option value="A"
                                                        ...
                                                        <td>
                                                            <select id="prom_{{ $key }}"
                                                                class="mobile form-select" name="prom[]" disabled>
                                                        ...
                                                        <td>
                                                            <input type="text" class="mobile form-control total_number"
                                                                ...
                                                                value="{{ $sale_prom->prom_total }}" readonly>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                                    ...
                                                    <tr id="row-{{ $key }}">
                                                        <td>
                                                            <select id="gdpaper_id_{{ $key }}"
                                                                alt="{{ $key }}" class="mobile form-select"
                                                                name="gdpaper_ids[]" onchange="chgPapers(this)" disabled>
                                                        ...
                                                        <td>
                                                            <input type="number" class="mobile form-control"
                                                                ...
                                                                onchange="chgNums(this)" readonly>
                                                        </td>
                                                        <td>
                                                            <input type="text" class="mobile form-control total_number"
                                                                id="gdpaper_total_{{ $key }}"
                                                                name="gdpaper_total[]"
                                                                value="{{ $sale_gdpaper->gdpaper_total }}" readonly>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-4" id="cash_price_div">
                                    ...
                                    <input type="text" class="form-control" id="cash_price" name="cash_price"
                                        value="{{ $data->cash_price }}" readonly>
                                </div>
                                <div class="mb-3 col-md-4" id="transfer_price_div">
                                    ...
                                    <input type="text" class="form-control" id="transfer_price" name="transfer_price"
                                        value="{{ $data->transfer_price }}" readonly>
                                </div>
                    ...
                    <div class="text-center mb-3">
                        @if (Auth::user()->level != '2' && Auth::user()->job_id == 9)
                            @if ($data->status == '3')
                                ...
                                <button type="submit" class="btn w-sm btn-dange waves-effect" value="not_check"
                                    name="admin_check">撤回對帳</button>
...
@section('script')
    ...
    <script>
        ...
        $('select[name="type"]').on('change', function() {
            if ($(this).val() == 'H' || $(this).val() == 'B' || $(this).val() == 'Salon' || $(this).val() == 'G' ||
                $(this).val() == 'dogpark' || $(this).val() == 'other') {
                $("#source_company").show(300);
                $("#source_company_name_q").prop('required', true);
            } else {
                $("#source_company").hide(300);
