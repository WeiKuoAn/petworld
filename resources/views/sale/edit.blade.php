                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div id="edit_check">
                                        <hr>
                                        <div class="form-check">
                                            <input type="checkbox" class="form-check-input" id="edit_contract"
                                                name="edit_contract" value="0">
                                            <label class="form-check-label" for="edit_contract"><b>修改契約</b></label>
                                        </div>
                                    </div>
                                    <div id="edit_div" class="col-md-4 mt-2">
                                        <div class="mb-3">
                                            <label for="edit_contract_id" class="form-label">契約選擇<span
                                                    class="text-danger">*</span></label>
                                                            ...
                                                            <td>
                                                                <select id="select_prom_{{ $key }}"
                                                                    ...
                                                                    <option value="C"
                                                                        ...
                                                                        祈福儀式</option>
                                                                    <option value="D"
                                                                        @if ($sale_prom->prom_type == 'D') selected @endif>
                                                                        法會報名</option>
                                                                </select>
                                                            </td>
                                                            <td>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $('#edit_contract_id').change(function() {
                            salePrice = $('#edit_contract_id option:selected').data(
                                'sale-price');
                        });
                        calculate_price();
                    }
