            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ number_format($check_sale) }}</span>單</h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ number_format($gdpaper_month) }}</span>元</h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1">$<span data-plugin="counterup">{{ number_format($price_month) }}</span>元</h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ number_format($pay_month) }}</span>元</h3>
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="text-end">
                                <h3 class="text-dark mt-1"><span data-plugin="counterup">{{ number_format($cust_nums) }}</span>人</h3>
