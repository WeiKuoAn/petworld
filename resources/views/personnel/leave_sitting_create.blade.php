@extends('layouts.vertical', ['page_title' => '新增假別天數'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">新增假別天數</li>
                        </ol>
                    </div>
                    <h4 class="page-title">新增假別天數</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form action="{{ route('personnel.leavesitting.create.data') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="project-priority" class="form-label">假別核定天數<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="approved_days" value=""
                                            required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="project-priority" class="form-label">單位<span
                                                class="text-danger">*</span></label>
