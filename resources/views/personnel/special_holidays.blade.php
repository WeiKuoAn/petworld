@extends('layouts.vertical', ["page_title"=> "特休總覽"])
...
<div class="container-fluid">
            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">特休總覽</li>
                    </ol>
                </div>
                <h4 class="page-title">特休總覽</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-auto">
                            <form class="d-flex flex-wrap align-items-center" action="{{ route('personnel.other_holidays') }}" method="GET">
                                <div class="me-sm-3">
    ...
    <div class="row">
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    <h3 class="header-title mb-3">{{ $data['name'] }}</h3>
