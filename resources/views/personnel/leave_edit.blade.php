@extends('layouts.vertical', ['page_title' => '編輯假別'])
                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">編輯假別</li>
                        </ol>
                    </div>
                    <h4 class="page-title">編輯假別</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
        <form action="{{ route('personnel.leaves.edit.data', $data->id) }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-xl-6">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="mb-3">
                                        <label for="project-priority" class="form-label">假別名稱<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" name="name"
                                            value="{{ $data->name }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="project-priority" class="form-label">排序<span
                                                class="text-danger">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" data-toggle="select" data-width="100%" name="status">
                                            <option value="0" @if ($data->status == 0) selected @endif>上架
                                            </option>
                                            <option value="1" @if ($data->status == 1) selected @endif>下架
                                            </option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">備註<span class="text-danger">*</span></label>
                                        <textarea class="form-control" rows="5" placeholder="" name="comment">{{ $data->comment }}</textarea>
                                    </div>
                                </div> <!-- end col-->
                            </div>
                            <!-- end row -->
