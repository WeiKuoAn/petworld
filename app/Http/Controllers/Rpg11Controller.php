...
class Rpg11Controller extends Controller
{
    public function rpg11(Request $request)
    {
        ...
        foreach($years as $year)
        {
            ...
            $datas[$year]['pay_price'] = PayData::where('pay_date','>=',$year.'-01-01')->where('pay_date','<=',$year.'-12-31')->sum('price');//總支出
        ...
        // dd($datas);
        return view('rpg11.index')->with('years', $years)->with('request', $request)->with('datas', $datas);
    }
}
